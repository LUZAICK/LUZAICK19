...
banChats = false
offline = false
targetpc = '50242725900'
owner = '50242725900'
fake = '𐦍ওৣ⃟⃜❤︎⋆∙𝐋𝐔𝐙𝐀𝐈𝐂𝐊-𝐁𝐎𝐓𝄤͜͡🌹᭄'
numbernye = '0'
waktu = '-'
alasan = '-'
//=================================================//
...
pato.on('chat-update', async (mek) => {
	try {
		...
		const ownerNumber = ['50242725900@s.whatsapp.net'] //owner 𐦍ওৣ⃟⃜❤︎⋆∙𝐋𝐔𝐙𝐀𝐈𝐂𝐊-𝐁𝐎𝐓𝄤͜͡🌹᭄
//SETTING WeA
...
➣ᴺᵒ ˢᵖᵃᵐ 
➣ᴺᵒ ˡˡᵃᵐᵃᵈᵃˢ
➣ᴾᵘᵉᵈᵉˢ ʰᵃᵇˡᵃʳˡᵉ ᵃˡ ᵇᵒᵗ ᵃˡ ᵖʳⁱᵛᵃᵈᵒ ᵖᵉʳᵒ ⁿᵒ ʰᵃᵍᵃˢ ˢᵖᵃᵐ 
➣ᴾᵃʳᵃ ᵐᵉᵗᵉʳ ᵉˡ ᵇᵒᵗ ᵃ ᵗᵘ ᵍʳᵘᵖᵒ ᵖᵘᵉᵈᵉˢ ᵖᵃᵍᵃʳ ᶜᵒⁿ ᵘⁿ ᶻⁱⁿᵍ ᵒ ᵘⁿ ⁿúᵐᵉʳᵒ ⁽ qᵘᵉ ⁿᵒ ˢᵉᵃ ⁺¹ ⁺⁹⁹⁴ ⁺⁴⁴ ⁾

┈┉•━─┉↯facebook↯━─┉•┉┈

https://www.facebook.com/groups/985876535239039/?ref=share
...
case prefix+ 'pinterest':
			...
			ke =  sasu[Math.floor(Math.random() * sasu.length)];
			nye = await getBuffer(ke)
			pato.sendMessage(from, nye, image, { caption: 'Powered bai gatau pinterest lah bang awokwok', quoted: mek })
			.catch(err => {
